...
int main(int argc, char *argv[])
{
   ...
   CompareClass compareClass(sortedBy, isAscending);//sorted by is chosen in arg 3 and isAscending is chosen in arg 4
   std::sort(employeeVector.begin(), employeeVector.end(), compareClass);// comp should return true if first is less than second
